...
@                 3600 IN SOA  ns.jaafarbendriss.com. admin.jaafarbendriss.com. ( 2014010800 ; Serial
                                          3600       ; Refresh
                                          3600       ; Retry
                                          3600       ; Expire
                                          300 )      ; Minimum TTL
...
bono.jaafarbendriss.com.                 IN A     157.159.232.174
;
...
;
; Per-node records - not required to have both IPv4 and IPv6 records
sprout.jaafarbendriss.com.               IN A     157.159.232.212
;
...
; Cluster A and AAAA records - P-CSCFs that don't support RFC 3263 will simply
; resolve the A or AAAA records and pick randomly from this set of addresses.
scscf.sprout.jaafarbendriss.com.           IN A     157.159.232.212
;
...
;
; Per-node records - not required to have both IPv4 and IPv6 records
hs.jaafarbendriss.com.           IN A         157.159.232.166
;
...
;
; Per-node records - not required to have both IPv4 and IPv6 records
homer.jaafarbendriss.com.                IN A     157.159.232.179
;
; Cluster A and AAAA records - sprout picks randomly from these.
homer.jaafarbendriss.com                  IN A     157.159.232.179
;
...
;
; Per-node records - not required to have both IPv4 and IPv6 records
ralf.jaafarbendriss.com.               IN A     157.159.232.165
;
...
ellis.jaafarbendriss.com.                IN A     157.159.232.198
;
